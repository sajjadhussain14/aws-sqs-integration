<cfcomponent displayname="AWS SQS App" output="true" hint="Handle the application.">

    <!--- Set up the application. --->
    <cfset THIS.Name = "AWS SQS App" />
...
<cfscript>
    ...
    <cfsetting requesttimeout="999999999" showdebugoutput="true" enablecfoutputonly="false" />
    ...
    <cffunction name="OnApplicationStart" access="public"  output="false" hint="Fires when the application is first created.">
        ...
        <cfscript>
            ...
            // AWS API CREDENTIALS 
            application.accessKeyId = "AKIAQJLMNXMA2C7NLVI5"; 
            application.secretAccessKey = "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";

            application.alias = "SQS";
